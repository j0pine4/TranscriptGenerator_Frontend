<template>
        ...
        <div class="grid grid-cols-12 gap-6 relative">
            ...
            <div class="col-span-12 md:col-span-8 bg-black/75 py-8 px-6 lg:px-24 rounded-xl my-4 print:border-none border-2 border-dark-gray backdrop:blur-3xl">
                ...
                <div class="text-white flex gap-4 items-center mb-6 justify-center print:hidden">
                    ...
                    <div class="flex flex-col items-center justify-center  text-primary font-bold cursor-pointer hover:scale-105 duration-300 transition-all" data-hs-overlay="#hs-bg-gray-on-hover-cards">
                    ...
                    <div class="flex flex-col items-center justify-center font-light cursor-pointer hover:text-primary duration-300 transition-all" @click='copy(state.transcript)'>
                ...
                <iframe class="w-full h-[500px] mb-12 rounded-xl" :src="'https://www.youtube.com/embed/' + video_id" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                ...
                <div v-if="!error">
                    ...
                    <p class="text-white print:text-black leading-8"> {{ transcript }} </p>
                </div>
  ...
  <script setup lang="ts">
    ...
    import { ClipboardDocumentIcon, PrinterIcon, ArrowLeftIcon, AcademicCapIcon, PencilSquareIcon, KeyIcon, MegaphoneIcon, QuestionMarkCircleIcon, GlobeAmericasIcon  } from '@heroicons/vue/24/outline'
