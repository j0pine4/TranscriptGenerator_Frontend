<template>
    ...
    <div class="relative">
        ...
        <div class="max-w-2xl mx-auto text-center mb-10">
            ...
            <p class="mt-2 lg:text-lg text-white">Whatever your status, our offers evolve according to your needs.</p>
        </div>
        <!-- End Title -->
        ...
        <div class="mt-6 md:mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-6 lg:gap-3 xl:gap-6 lg:items-center">
            ...
            <div class="flex flex-col bg-white/10 border backdrop-blur border-gray-200 text-center rounded-2xl p-4 md:p-8">
                <h4 class="font-medium text-lg text-white">Free</h4>
        ...
        <div class="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[340px] h-[340px] border border-dashed border-violet-200 rounded-full dark:border-primary/60"></div>
        <div class="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[575px] h-[575px] border border-dashed border-violet-200 rounded-full opacity-80 dark:border-primary/60"></div>
        <div class="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[840px] h-[840px] border border-dashed border-violet-200 rounded-full opacity-60 dark:border-primary/60"></div>
        <div class="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[1080px] h-[1080px] border border-dashed border-violet-200 rounded-full opacity-40 dark:border-primary/60"></div>
    </div>
    <!-- End Hero -->
    </div>
